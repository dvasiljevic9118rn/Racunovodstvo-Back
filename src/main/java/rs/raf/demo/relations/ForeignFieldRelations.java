...
public abstract class ForeignFieldRelations<T> extends RacunRelations<T> {

    protected Expression<Long> idExpression;
    protected final Long id;

    public ForeignFieldRelations(Root<T> root, CriteriaBuilder builder, String key, String val) {
